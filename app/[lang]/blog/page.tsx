...
export const metadata: Metadata = {
  ...
  description: "Read our latest articles about invisible text, its applications, and creative uses in gaming, social media, and more.",
  openGraph: {
    title: "Blog | Invisible Text Generator",
...
export default function BlogPage() {
  ...
  const structuredData = {
    ...
    description: "Articles about invisible text, its applications, and creative uses in gaming, social media, and more.",
    url: "https://invisibletext.top/blog",
    publisher: {
      "@type": "Organization",
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-xl border-2 border-black shadow-lg text-center">
            ...
            <p className="mb-6">Try our invisible text generator and discover creative ways to use invisible characters.</p>
            <Link
              href="/en"
